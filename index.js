    ...
    return new Promise(function(resolve){    
        ...
        for(var i = 0; i < result.length; i++){  
            ...
            let promise = new Promise(function(resolveExcel){ 
                ...
                console.log(moment(element.datahora).utc().format())
    
                let row = {
                    id: i, 
                    data: moment(element.datahora).utc().format("DD/MM/YYYY"), 
                    hora: moment(element.datahora).utc().format("hh:mm:ss"), 
                    nome: name,
                    ponto: element.PONTO,
                    tipo: element.tipo, 
                    setor: element.SETOR, 
...
function populateSync(array, worksheet, db, rowSintetico){
    ...
    return new Promise(function(resolve){ 
        ...
        .then((result) => {
            ...
            result.forEach((element) => {                
                let promisee = popularSinteticoExcel(element, worksheet, rowSintetico++)
